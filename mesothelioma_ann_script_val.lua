...
if string.match(fileName, "withoutDiagnosisMethod")=="withoutDiagnosisMethod" then
  max_values = {85, 1, 8, 1, 2, 70, 2, 1, 52, 1, 1, 1, 3, 1, 21500, 22, 1, 3335, 129, 1128, 489, 8.5, 6.9, 421, 7541, 6.7, 4.4, 151, 1, 1, 1, 1, 103}
-- replace with an automated function
else
  max_values = {85, 1, 8, 1, 2, 70, 1, 2, 1, 52, 1, 1, 1, 3, 1, 21500, 22, 1, 3335, 129, 1128, 489, 8.5, 6.9, 421, 7541, 6.7, 4.4, 151, 1, 1, 1, 1, 103}
end
